...
namespace DEV2
{
    class MainClass
    {
        static void Main(string[] args)
        {
            ...
            /*
            MainClass translator = new MainCLass();
            string check = args.LanguageChecker(); // Form string from arguments array
            TranslatorClass translate = new TranslatorClass();
            translate.LanguageChecker(ref stringCheck);
            ...
            */
            ...
            MainClass EntryPointObject = new MainClass();
            //string inputString = args.ArrayToString(); // Form string from arguments array 
            TranslatorClass entryTransliteration = new TranslatorClass();
           // entryTransliteration.TranslatorClass(ref stringCheck);
            Console.WriteLine("your transliterated string: " stringCheck);
